...
let msgC = document.querySelector(".msg p");
...
const resetGame = () => {
    ...
    msgC.innerText = ""; // Reset the message text
}
...
const enableBoxes = () => {
    for (let box of boxes) {
        box.disabled = false;
        box.innerText = "";
        box.querySelectorAll('.line').forEach(line => line.remove()); // Remove all lines
    }
}

// Show the winner and the winning line
    ...
    for (let pattern of winPatterns) {
        ...
        if (pos1 !== "" && pos2 !== "" && pos3 !== "") {
            if (pos1 === pos2 && pos2 === pos3) {
                ...
                showWinner(pos1, pattern); // Pass the winning pattern
